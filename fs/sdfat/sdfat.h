...
extern void sdfat_time_fat2unix(struct sdfat_sb_info *sbi, struct timespec_compact *ts,
				DATE_TIME_T *tp);
extern void sdfat_time_unix2fat(struct sdfat_sb_info *sbi, struct timespec_compact *ts,
				DATE_TIME_T *tp);
